...
rx_stands.r <- rast(file.path('..', 'ext_BiomassHarvestStands_OkaMet.tif'))  # use a different, fixed set of stands since SCRAPPLE doesn't reload with each timestep
topo_asp.r <- rast(file.path('..', 'TopoAsp_OkaMet.tif'))
