...
if (!file.exists(file.path(landisOutputDir,'Biomass_Annual_Dynamics.csv'))){
  ...
  cat('------------------------\n Loading Species Biomass\n------------------------')
  biomass.dynamics.df <- read.csv(file.path(landisOutputDir,'Biomass_Annual_Dynamics.csv'))
}
